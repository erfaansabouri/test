            ...
            <div class="col-12">
                <div class="card card-flush h-lg-100" id="kt_contacts_main">
                    ...
                    <div class="card-body pt-5">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action="@if(isset($lottery)) {{ route('store-manager.lotteries.update', $lottery->id) }} @else {{ route('store-manager.lotteries.store') }} @endif">
                            @csrf
                            @method('POST')
                            <!--begin::کارت body-->
                                                ...
                                                <div class="input-group  mb-5">
                                                    <select class="form-select" name="store_level_id">
                                                        ...
                                                        @foreach($store_levels as $store_level)
                                                            <option @if(isset($lottery) && $lottery->store_level_id == $store_level->id) selected @endif value="{{ $store_level->id }}">{{ $store_level->level_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="input-group-text" id="basic-addon2">-</span>
                                                </div>
