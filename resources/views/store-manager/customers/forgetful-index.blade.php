...
@section('content')
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <form  method="GET" action="{{ route('store-manager.customers.forgetful-index') }}">
                ...
                <table class="table table-striped table-bordered table-hover align-middle table-row-dashed fs-6 gy-5" >
                    ...
                    @foreach($customers as $customer)
                        <tr class="text-center">
                            ...
                            <td>{{ verta($customer->points()->interactWithStore($store_manager->id)->latest()->first()->created_at)->format('Y/m/d H:i') }}</td>
