...
@section('content')
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            <form  method="GET" action="{{ route('store-manager.customers.index') }}">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <!--begin::Add user-->
                    <a href="{{ route('store-manager.customers.create') }}" class="btn btn-light-success">
                    ...
                    @foreach($customers as $customer)
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <a href="{{ route('store-manager.coupons.index', ['customer_id' => $customer->id]) }}" class="btn btn-light-info">تاریخچه آفر های دریافتی</a>
