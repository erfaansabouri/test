...
@section('content')
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('store-manager.points.store-purchase') }}">
                @csrf
                @method('POST')
                <!--begin::کارت body-->
                            ...
                            <div class="row">
                                <div class="col-lg-6 fv-row">
                                    <div class="input-group  mb-5">
                                        <input id="price" type="text" name="price price-input" class="form-control" placeholder="مبلغ خرید" aria-label="مبلغ خرید" aria-describedby="basic-addon3">
                                    </div>
                                </div>
                            </div>
                        </div>
