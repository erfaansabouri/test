            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            <form method="GET" action="{{ route('admin.charts.store-point') }}">
...
@push('scripts')
    <script>
        ...
        // Chart labels
        const labels = @json((clone $store_sums)->pluck('store_title')->all());
        ...
        const data = {
            ...
            datasets: [
                {
                    label: 'امتیاز',
                    data: @json((clone $store_sums)->pluck('total_points')->all()),
                    borderColor: '#36A2EB',
