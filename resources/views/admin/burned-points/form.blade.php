            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        @endif
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ route('admin.burned-points.store') }}">
                            @csrf
                            @method('POST')
                            <!--begin::کارت body-->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 fv-row">
                                                <div class="input-group  mb-5">
                                                    <input autocomplete="off"  id="value" type="text" name="point" value="{{ old('point') }}"
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="{{ route('admin.burned-points.index') }}" type="reset" class="btn btn-light btn-active-light-primary me-2">لغو</a>
