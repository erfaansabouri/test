                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 fv-row">
                                                <div class="input-group  mb-5">
                                                    <input value="{{ $point_setting->price }}" type="text" name="price" class="form-control price-input" placeholder="مبلغ به تومان" aria-label="مبلغ به تومان" aria-describedby="basic-addon2">
